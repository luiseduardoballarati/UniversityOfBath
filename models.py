...
class Aircraft(db.Model):
  ...
  def __init__(self, manufacturer, model, passenger_capacity, cruising_range_miles):
...
class Route(db.Model):
    ...
    arrival_airport_id = db.Column(db.Integer, db.ForeignKey('airport.airport_id'), nullable=False)
...
class Flight(db.Model):
  ...
  flight_id = db.Column(db.Integer, primary_key=True, auto_increment=True)
  ...
  def __init__(self, aircraft_id, route_id, departure_date, departure_time, arrival_date, arrival_time):
...
class FlightDetail(db.Model):
  ...
  flight_detail_id = db.Column(db.Integer, primary_key=True, auto_increment=True)
  flight_id = db.Column(db.Integer, db.ForeignKey('flight.flight_id'), nullable=False)
  pilot_id = db.Column(db.Integer, db.ForeignKey('pilot.pilot_id'), nullable=False)
